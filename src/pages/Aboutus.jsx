...
export const Aboutus = () => {
  return (
    <div className={styles.container}>
        <div>
            <h4>Introduction</h4>
            <p>Myntra is a one stop shop for all your fashion and lifestyle needs. 
